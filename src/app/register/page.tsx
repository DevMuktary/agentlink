      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[40%] bg-slate-900 relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10 bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl p-6 shadow-2xl">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-white">Isah A.</p>
                    ...
                    <div className="flex gap-2">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          className={`block w-full pl-10 pr-3 py-3 text-sm rounded-xl shadow-sm focus:outline-none focus:ring-2 transition-all ${isEmailVerified
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`block w-full pl-10 pr-10 py-3 text-sm bg-white dark:bg-slate-900 border rounded-xl focus:outline-none focus:ring-2 transition-all shadow-sm ${formData.confirmPassword && formData.password !== formData.confirmPassword
                    ...
                    <div className="px-1">
                      <div className="flex gap-1 h-1.5 w-full max-w-[200px]">
                        {[1, 2, 3, 4, 5].map((level) => (
                          <div
                            key={level}
                            className={`flex-1 rounded-full transition-all duration-300 ${passStrength >= level
